...
object ParApp extends App {
  ...
  val es  = ExecutionContext.fromExecutorService(Executors.newWorkStealingPool(50))

  val forked = timed(  parMap(List.fill(20)(10)) (_ * 2)(es) )

  val notforked = timed(  _parMap(List.fill(20)(10)) (_ * 2)(es) )
